 ...
 */
public class ChannelDataHelper<T extends  ChannelEntity.ChannelEntityCreater> implements ChannelAdapter.DataChangeListenter, View.OnClickListener {
    ...
    public ChannelDataHelper(@NonNull Context context, @NonNull ChannelDataRefreshListenter channelDataRefreshListenter, @NonNull View showView) {
